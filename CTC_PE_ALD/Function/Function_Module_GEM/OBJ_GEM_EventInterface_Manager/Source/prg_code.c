...
// DCOP for each Process Job Start
	...
	int  PM1_WETCWfrCnt, PM1_DRYCWfrCnt, PM1_TRAPCWfrCnt, PM2_WETCWfrCnt, PM2_DRYCWfrCnt, PM2_TRAPCWfrCnt, PM3_WETCWfrCnt, PM3_DRYCWfrCnt, PM3_TRAPCWfrCnt;
	double DcopValue ;
...
//								memset(pszFtnName, 0, sizeof(pszFtnName));
								...
								if(FALSE == g_sLPMA_PMUse.bPMUse[nModuleIndex])
								{
//									LOG(pszFtnName, ELT_File, "LPMA PM1 Use = [FALSE] at [PJID = %s]", szPJID);
									for ( i = nFirstStringIOEnum ; i <= nLastStringIOEnum  ; i++ )
									{
										WRITE_STRING ( i, "", &nCommStatus ) ;
									}
									WRITE_DIGITAL (GEM_PM1_WETCWfrCnt, 0, &nCommStatus);
									WRITE_DIGITAL (GEM_PM1_DRYCWfrCnt, 0, &nCommStatus);
									WRITE_DIGITAL (GEM_PM1_TRAPCWfrCnt, 0, &nCommStatus);
								}
								else
								{
									j = 0;
									PM1_WETCWfrCnt = READ_DIGITAL (PRMD_PM1_WETCWfrCnt, &nCommStatus);
									PM1_DRYCWfrCnt = READ_DIGITAL (PRMD_PM1_DRYCWfrCnt, &nCommStatus);
									PM1_TRAPCWfrCnt = READ_DIGITAL (PRMD_PM1_TRAPCWfrCnt, &nCommStatus);
//									LOG(pszFtnName, ELT_File, "LPMA PM1 Use = [TRUE] at [PJID = %s]", szPJID);
									for ( i = nStartIOEnum ; i <= nEndIOEnum ; i++, j++ )
									{
										DcopValue = READ_ANALOG ( i ,&nCommStatus);
										//if (DcopValue == -99 || 0 == (int) DcopValue )
										if (DcopValue == -99)
										{
									...
									WRITE_DIGITAL (GEM_PM1_WETCWfrCnt, PM1_WETCWfrCnt, &nCommStatus);
									WRITE_DIGITAL (GEM_PM1_DRYCWfrCnt, PM1_DRYCWfrCnt, &nCommStatus);
									WRITE_DIGITAL (GEM_PM1_TRAPCWfrCnt, PM1_TRAPCWfrCnt, &nCommStatus);
								}
							}
							break;
						case 2 :
...
//								memset(pszFtnName, 0, sizeof(pszFtnName));
								...
								if(FALSE == g_sLPMA_PMUse.bPMUse[nModuleIndex])
								{
//									LOG(pszFtnName, ELT_File, "LPMA PM2 Use = [FALSE] at [PJID = %s]", szPJID);
									for ( i = nFirstStringIOEnum ; i <= nLastStringIOEnum  ; i++ )
									{
										WRITE_STRING ( i, "", &nCommStatus ) ;
									}
...
//									LOG(pszFtnName, ELT_File, "LPMA PM2 Use = [TRUE] at [PJID = %s]", szPJID);
									for ( i = nStartIOEnum ; i <= nEndIOEnum ; i++, j++ )
									{
										DcopValue = READ_ANALOG ( i ,&nCommStatus);
										//if (DcopValue == -99 || 0 == (int) DcopValue )
...
//								memset(pszFtnName, 0, sizeof(pszFtnName));
								...
								if(FALSE == g_sLPMA_PMUse.bPMUse[nModuleIndex])
								{
//									LOG(pszFtnName, ELT_File, "LPMA PM3 Use = [FALSE] at [PJID = %s]", szPJID);
									for ( i = nFirstStringIOEnum ; i <= nLastStringIOEnum  ; i++ )
									{
										WRITE_STRING ( i, "", &nCommStatus ) ;
									}
...
//									LOG(pszFtnName, ELT_File, "LPMA PM3 Use = [TRUE] at [PJID = %s]", szPJID);
									for ( i = nStartIOEnum ; i <= nEndIOEnum ; i++, j++ )
									{
										DcopValue = READ_ANALOG ( i ,&nCommStatus);
										//if (DcopValue == -99 || 0 == (int) DcopValue )
						...
						case 1 :
							{
								...
								nFirstStringIOEnum = PM1V_PRO_CurStepAM_LAvr;
								nLastStringIOEnum = PM1V_StgHtr2VoltAI_LAvr2;
								if(FALSE == g_sLPMB_PMUse.bPMUse[nModuleIndex])
								{
									for ( i = nFirstStringIOEnum ; i <= nLastStringIOEnum ; i++ )
									{
										WRITE_STRING ( i, "", &nCommStatus ) ;
						...
						case 1 :
							{
								...
								nFirstStringIOEnum = PM1V_PRO_CurStepAM_LAvr;
								nLastStringIOEnum = PM1V_StgHtr2VoltAI_LAvr2;
								if(FALSE == g_sLPMC_PMUse.bPMUse[nModuleIndex])
								{
									for ( i = nFirstStringIOEnum ; i <= nLastStringIOEnum  ; i++ )
									{
										WRITE_STRING ( i, "", &nCommStatus ) ;
